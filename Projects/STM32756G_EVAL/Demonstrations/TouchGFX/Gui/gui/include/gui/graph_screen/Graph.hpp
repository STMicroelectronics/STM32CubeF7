...
#elif USE_BPP==4
    PainterGRAY4 graphLinePainter;           ///< Painter for the line
    PainterGRAY4 graphDotsPainter;           ///< Painter for the dots (usually the same as graphLinePainter)
    PainterGRAY4 graphDotsBackgroundPainter; ///< Painter for the background of the dots
#elif USE_BPP==2
    PainterGRAY2 graphLinePainter;           ///< Painter for the line
    PainterGRAY2 graphDotsPainter;           ///< Painter for the dots (usually the same as graphLinePainter)
    PainterGRAY2 graphDotsBackgroundPainter; ///< Painter for the background of the dots
#else
#error Unknown USE_BPP
#endif
