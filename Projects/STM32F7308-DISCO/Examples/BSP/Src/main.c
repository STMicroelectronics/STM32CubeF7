/**
  ...
  * @brief   This example code shows how to use the STM32F7308_DISCOVERY BSP Drivers
  ******************************************************************************
  * @attention
  *
...
static void Display_DemoDescription(void)
{
  ...
  BSP_LCD_DisplayStringAt(0, BSP_LCD_GetYSize()-12, (uint8_t *)"STMicroelectronics 2018", CENTER_MODE);
...
static void MPU_ConfigPSRAM(void)
{
  ...
  /* Configure the MPU attributes as normal WB-RA for PSRAM */
  MPU_InitStruct.Enable = MPU_REGION_ENABLE;
