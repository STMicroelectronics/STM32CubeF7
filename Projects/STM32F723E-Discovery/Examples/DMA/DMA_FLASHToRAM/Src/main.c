...
int main(void)
{
  ...
  {
    /* Toggle LED6 on in case of DMA transfer error */
    LED_Blinking(200);
  }
  else if (transferCompleteDetected == 1)
  {
    /* Turn LED6 on in case of completed DMA transfer */
    BSP_LED_On(LED6);
    /*
...
/**
  * @brief  Set LED6 to Blinking mode for an infinite loop (toggle period based on value provided as input parameter).
