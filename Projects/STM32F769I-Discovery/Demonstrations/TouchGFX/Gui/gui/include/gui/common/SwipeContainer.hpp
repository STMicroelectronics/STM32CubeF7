...
public:
     ...
     */
    uint8_t getNumberOfScreens() { return numberOfScreens; }
    ...
    /**
     * @fn uint8_t SwipeContainer::getSelectedScreen()
     *
     * @brief Gets selected screen.
     *
     * @return The selected screen.
     */
    uint8_t getSelectedScreen() { return currentScreen; }
     ...
     * @see GenericCallback
     */
    void setMenuChangeInitiatedCallback(touchgfx::GenericCallback<const SwipeContainer&>& callback) { menuChangeInitiatedAction = &callback; }
     ...
     * @see GenericCallback
     */
    void setMenuChangeEndedCallback(touchgfx::GenericCallback<const SwipeContainer&>& callback) { menuChangeEndedAction = &callback; }
