...
{
    background.setBitmap(Bitmap(BITMAP_HOME_AUTOMATION_BACKGROUND_ID));
    ...
    backButton.setBitmaps(Bitmap(BITMAP_HOME_BACK_BUTTON_ID), Bitmap(BITMAP_HOME_BACK_BUTTON_PRESSED_ID));
    ...
    //loginWidget.setBitmapsAndHitBoxes(BITMAP_NODE_00_ID, BITMAP_NODE_65_ID, 80, 80);
