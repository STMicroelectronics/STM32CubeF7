...
void AUDIO_MenuProcess(void)
{
  ...
  case AUDIO_DEMO_IDLE:
    ...
    BSP_LCD_DisplayStringAtLine(26, (uint8_t *)"Use [Joystick Up/Down] to scroll audio menu      ");
    ...
    if(audio_demo.select != prev_select)
    {
      ...
      if(audio_demo.select & 0x80)
      {
        ...
        case 1:
          ...
          BSP_LCD_DisplayStringAtLine(24, (uint8_t *)"Use [User Tamper] To Stop and return from player");
          BSP_LCD_SetTextColor(LCD_COLOR_WHITE);
