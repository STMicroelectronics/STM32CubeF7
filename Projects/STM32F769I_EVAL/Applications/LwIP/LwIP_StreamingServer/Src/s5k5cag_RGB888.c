...
/** Note: this file is the s5k5cag.c modified to support the RGB888 format.
          (Modification of #REG_0TC_PCFG_Format)*/

/* Includes ------------------------------------------------------------------*/
#include "s5k5cag_RGB888.h"
...
const uint16_t S5K5CAG_480x272[][2]=
{
  ...
  {0x0F12, 0x0001}, /* #REG_0TC_PCFG_Format */
