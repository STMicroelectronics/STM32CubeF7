...
public:
    ...
    {
        // Default behavior is to go to Custom Control Screen
        static_cast<FrontendApplication*>(Application::getInstance())->gotoCustomControlsScreenSlideTransitionSouth();
    }
