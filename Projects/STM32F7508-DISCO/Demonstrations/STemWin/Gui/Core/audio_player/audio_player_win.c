...
/* Deleting this window will cause the k_menu to set the .in_use to '0' for this
   modules which is not coherent later */
#if 0
/**
...
#else /* !AUDIO_USE_SPIRIT_EQUALIZER */
    /* Hide the Eq button */
    hItem = BUTTON_CreateEx(360, 230, 50, 50, pMsg->hWin, WM_CF_HIDE, 0, ID_EQUAL_BUTTON);
#endif /* AUDIO_USE_SPIRIT_EQUALIZER */
