...
static const GUI_WIDGET_CREATE_INFO _aDialog[] = 
{
  ...
  { TEXT_CreateIndirect, " STM32F7508", ID_TEXT_BOARD_1,  30,  190, 90, 20, 0, 0x0, 0 },
  ...
  { TEXT_CreateIndirect, "V1.1.0 ", ID_TEXT_VERSION_1,    385, 200, 80, 20, 0, 0x0, 0 }, 
  
  { TEXT_CreateIndirect, "Copyright (c) STMicroelectronics 2018", ID_TEXT_COPYRIGHT, 260, 253, 240, 20, 0, 0x0, 0 },
};
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    /* Initialization of 'Board : STM32F7508' */
